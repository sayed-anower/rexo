...
export function buildPlanFeatures(def: PlanDefinition): PlanFeature[] {
  const feats: PlanFeature[] = [
    { id: 'recovery_volume', label: def.invoice_limit, included: true },
    ...
    { id: 'ai', label: `${def.limits.ai_generations === -1 ? 'Unlimited' : `${def.limits.ai_generations} `} AI email & sequence drafts`, included: def.limits.ai_generations > 0 },
...
export const PLANS: PlanDefinition[] = [
  plan(
    ...
    'Up To $50k recovery volume',
    {
      ...
      team_seats: 1,
      emails_per_month: 600,
      whatsapp_per_month: 200,
      SMS_per_month: 100,
      ai_generations: 50,
  ...
  plan(
    ...
    {
      tracked_invoices: 5000,
      team_seats: 10,
      emails_per_month: 10000,
      whatsapp_per_month: 2500,
      SMS_per_month: 1200,
      ai_generations: 1000,
