...
export function HelpPage({ user }: HelpPageProps) {
  ...
  const guides = [
    ...
    },
    {
      ...
      body: 'If you need a refund, please email us at ' + SUPPORT_EMAIL + ' with your company name and request. Our support team will review your request and respond within 24-48 hours. Refund eligibility is evaluated on a case-by-case basis.',
    },
  ];
