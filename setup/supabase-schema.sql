...
-- last_run_at: exact once-per-occurrence guard (CAS claim by the cron worker).
...
-- Automatic transfers of collected client payments to the selected payout
-- destination (Payoneer MassPayouts when configured; otherwise queued).
